...
class Database{
    ...
    public function contact_details($name, $email, $phone, $message){

        $sql = "INSERT INTO ken_web.contact_form (name, email, phone_number, message) VALUES (:name, :email, :phone, :message)";
    ...
    public function demo_details($uniqueID, $name, $email, $phone, $date, $message){

        $sql = "INSERT INTO ken_web.demo_form (uniqueID, name, email, phone_number, date, message) VALUES (:uniqueID, :name, :email, :phone, :date, :message)";

        $stmt = $this->conn->prepare($sql);

        $stmt->execute(['uniqueID' => $uniqueID, 'name' => $name, 'email' => $email, 'phone' => $phone, 'date' => $date,'message' => $message]);
