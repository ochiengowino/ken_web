                        ...
                        <div class="content d-flex flex-column justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-md-6 icon-box" data-aos="fade-up">
                                    ...
                                    <h4>Our Mission</h4>
                                    <p>To provide high quality individualized, customizable niche IT solutions available widely for everyday needs.</p>
                                </div>
                ...
                <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="client-logo">
                            <a href="https://www.kisumu.go.ke/"><img src="assets/img/clients/CGK_Website_Logo2.png" class="img-fluid" alt=""></a>
                        </div>
                    </div>
        ...
        <!-- <section class="section cta-section">
            <div class="container">
                <div class="row align-items-center" data-aos="fade-out" data-aos-delay="100">
                    ...
                    <div class="col-md-5 text-center text-md-end down-btn">

                        <a href="https://apps.apple.com/cl/app/sayvu/id1081148815" class="btn btn-lg d-inline-flex align-items-center "><i class="bx bxl-apple bx-lg"></i><span id="apple-text">App store</span></a>
