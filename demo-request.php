        ...
        <section id="contact" class="contact">
            <div class="container">
                ...
                <div class="row mt-5 justify-content-center" data-aos="fade-up">
                    <div class="col-lg-10">
                        <form role="form" class="php-email-form" id="send-demo-form" autocomplete="on">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="date" id="date" width="270" placeholder="Date" required>
                            </div>
                            <div class="form-group mt-3">
                            ...
                            <div class="my-3">
                                ...
                                <div class="sent-demo-message">Your request has been sent. Thank you!</div>
                            </div>
                            <!-- <div class="text-center"><a type="submit" class="btn btn-danger btn-lg" id="formSubmit" onClick="sendDemo();">Submit</a>
                            </div> -->
                            <div class="form-group mt-3">
                                <input type="submit" id="sendDemoBtn" value="Submit" class="btn btn-primary btn-lg btn-block myBtn">
                            </div>
