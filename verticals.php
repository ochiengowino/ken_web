...
<body>
        ...
        <div class="container d-flex justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="active" href="verticals.php">Solution Verticals</a></li>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>Solution Verticals</h2>
                <ol>
                    <li><a href="index.php">Home</a></li>
                    <li>Solution Verticals</li>
                </ol>
            </div>
    ...
    <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
                        <div class="about-img">
                            <img src="assets/img/safe-city1.png" alt="">
                        </div>
                    </div>
        ...
        <section id="about2" class="about2">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2 content" data-aos="zoom-in" data-aos-delay="100">
                        <h2>
                            Corporate & Employees Security</h2>
                        <!-- <p class="fst-italic">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                        </p>
                        <ul>
                        ...
                        <p>
                            While the awareness of the liability for workers grows, their independence increases and remote work is more prevalent, organizations are encouraged to provide better solutions for their workers’ safety and personal security. With SayVU, employees can
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 ">
                        <div class="about-img">
                            <img src="assets/img/corporate-employee.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="about3" class="about3">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
                        <div class="about-img">
                            <img src="assets/img/responders.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
